...
<section class="card">
	...
	<p>
		When both methods detect ovulation within the same 2-day window, the BBT-confirmed date is used
	...
	<p>
		...
		egg-white) triggers the "peak + 3" rule: the fertile window extends 3 additional days after the
...
<section class="card">
	...
	<p>
		Encryption uses AES-256-GCM, and your encryption key is derived from your password using PBKDF2
		(100,000 iterations, SHA-256). The key never leaves your device.
	</p>
	<div class="highlight">
